public class View {
    ...
    public void printTotal(Model servicio) {
        ...
        System.out.println("Descuento o sobrecosto: " + (-1 * servicio.getDescuentoTotal()));
        System.out.println("Impuesto por infraestructura: " + servicio.getImpuestoTotal());
        System.out.println("TOTAL A PAGAR: " + servicio.getTotalTotal() + "\n");
    }
}